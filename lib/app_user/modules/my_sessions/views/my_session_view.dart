...
class MySessionView extends StatelessWidget {
  MySessionView({super.key});

  final MySessionController controller = Get.put(MySessionController());
          ...
          return GestureDetector(
            ...
            onTap: () {
              final user = ChatUserModel(
                ...
                avatar: chat["avatar"] ?? "https://images.unsplash.com/photo-1526256262350-7da7584cf5eb",
        ...
        children: [
          ...
          Stack(
            children: [
              CircleAvatar(
                radius: 22.r,
                backgroundImage: NetworkImage("https://images.unsplash.com/photo-1526256262350-7da7584cf5eb"),
              ),
              if (isOnline)
                Positioned(
                  bottom: 1,
