...
import 'package:live_health/app_psychic/modules/my_sessions_views/model/message_model.dart';
import 'package:live_health/app_psychic/modules/my_sessions_views/widgets/clear_chat_bottom_sheets.dart';
import 'package:live_health/app_psychic/modules/my_sessions_views/widgets/show_block_bottom_sheets.dart';
import 'package:live_health/app_psychic/modules/my_sessions_views/widgets/show_unblock_bottom_sheets.dart';

class ChatViews extends StatelessWidget {
  final ChatUserModel user;

  ChatViews({super.key, required this.user});

  late final ChatControllerViews controller = Get.put(
    ChatControllerViews(user),
    tag: user.id,
  );
