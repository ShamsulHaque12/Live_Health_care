...
import '../controller/my_profile_controller_views.dart';

class MyProfileViews extends StatelessWidget {
  MyProfileViews({super.key});
  final MyProfileControllerViews controller = Get.put(MyProfileControllerViews());
