...
import 'package:live_health/app_psychic/modules/session_history_views/controller/session_history_controller_views.dart';
import 'package:live_health/app_theme/app_colors.dart';
import 'package:live_health/core/global_widgets/custom_app_bar.dart';


class SessionHistoryViews extends StatelessWidget {
  SessionHistoryViews({super.key});

  final SessionHistoryControllerViews controller = Get.put(
    SessionHistoryControllerViews(),
  );
