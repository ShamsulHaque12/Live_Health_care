...
import 'package:live_health/app_psychic/modules/review_rattings_views/controller/review_controller_views.dart';
import 'package:live_health/app_theme/app_colors.dart';
import 'package:live_health/core/global_widgets/custom_app_bar.dart';

class ReviewRattingViews extends StatelessWidget {
  const ReviewRattingViews({super.key});

  @override
  Widget build(BuildContext context) {
    final ReviewControllerViews controller = Get.put(ReviewControllerViews());
